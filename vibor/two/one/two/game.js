...
var play = new Image();
play.src = "img/jul.jpg";
var i=0;
var g=0;
var e=0;
function clickg()
{
//	var knopka3=document.getElementById("image");
//	var img = new Array('img/fon.jpg');
	g=+1;
//	ctxStats.fillText("H e a l t h " + g + " - " + e, 10, 400);
	 document.img111.src='img/E_ANmEexRSo.png';
	document.img.src='img/oAkNzL9PsxQ.png';
	
}
function clicke()
{
	e=+1;
	document.img.src='img/5AROdvwLlqQ.png';
	document.img111.src='img/wxcKWeFyKig.png';
}
